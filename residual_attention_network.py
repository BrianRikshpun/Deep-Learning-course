...
from .attention_module import AttentionModule_stage1_cifar, AttentionModule_stage2_cifar, AttentionModule_stage3_cifar, AttentionModule_stage4_cifar
...
class ResidualAttentionModel_92_32input_update(nn.Module):
    ...
    def __init__(self):
        ...
        self.attention_module4 = AttentionModule_stage4_cifar(512, 512)  # 8*8
        self.attention_module4_2 = AttentionModule_stage4_cifar(512, 512)  # 8*8 # tbq add
        self.attention_module4_3 = AttentionModule_stage4_cifar(512, 512)
        self.attention_module4_4 = AttentionModule_stage4_cifar(512, 512)
        self.residual_block5 = ResidualBlock(512, 1024)  # 8*8
        self.residual_block6 = ResidualBlock(1024, 1024)  # 8*8
        self.residual_block7 = ResidualBlock(1024, 1024)  # 8*8
        self.mpool2 = nn.Sequential(
            nn.BatchNorm2d(1024),
            nn.ReLU(inplace=True),
    ...
    def forward(self, x):
        ...
        out = self.attention_module4_2(out)
        out = self.attention_module4_3(out)
        out = self.attention_module4_4(out)
        out = self.residual_block5(out)
        out = self.residual_block6(out)
